...
def main(args):
    ...
    models_ckpt = [torch.load(model_ckpt) for model_ckpt in args.models]
    ...
    merged_state_dict = merger.merge(args.merge_type, weights=args.weights, density=args.density)
